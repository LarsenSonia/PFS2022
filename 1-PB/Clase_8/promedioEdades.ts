...
//Devuelve numero aleatorio entre un minimo y un maximo
...
console.log(`Las edades del equipos son ${equipo}`);
console.log(`El promedio de las eddes del equipo es ${promediarEdades(equipo)}`);